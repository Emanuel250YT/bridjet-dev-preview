...
const API_KEY = 'YnQAEVAnDoNX5ouq08qjc2lWw7XY6Upg'
const ETH_BASE = '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE' as Address
const USDC_BASE = '0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913' as Address

async function swapOnBase() {
  try {
    console.log('🔄 Swap ETH → USDC en Base (mínimo)\n')
